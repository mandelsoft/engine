...
type ProcessingModel = common.ProcessingModel
...
func (p *processingModel) MetaModel() common.MetaModel {
	return p.mm
}
...
func (p *processingModel) GetElement(id ElementId) common.Element {
	p.lock.Lock()
	defer p.lock.Unlock()
...
func (m *processingModel) assureNamespace(log logging.Logger, name string, create bool) (*namespaceInfo, error) {
	...
	if ni == nil {
		...
		ni = newNamespaceInfo(b.(common.NamespaceObject))
